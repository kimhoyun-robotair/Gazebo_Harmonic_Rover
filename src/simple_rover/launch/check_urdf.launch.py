...
def generate_launch_description():
    ...
    pkg_simple_rover = FindPackageShare('simple_rover')
    default_rviz_config_path = PathJoinSubstitution([pkg_simple_rover, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within the simple_rover package
